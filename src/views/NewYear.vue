<template>
  <div class="body">
    ...
    <div class="firework" ref="firework"></div>

    <div class="publication" v-if="counter % publication_interval < 2">
      <MyPublication
        :publication="this.publications[this.show_publication_idx]"
      ></MyPublication>
    </div>
    ...
    // stars in sky
    {
      ...
      for (let idx = 0; idx < star_num; idx++) {
        ...
        Object.defineProperty(
          star.dataset,
          Object.keys(this.$refs.sky.dataset)[0],
          {
            value: "",
          }
        );
        star.style =
          ...
          "px; height: " +
          size +
          "px; -webkit-animation: shine " +
          shine_time +
          "s linear " +
          shine_delay +
          "s infinite; animation: shine " +
          shine_time +
          "s linear " +
          shine_delay +
          "s infinite;";
    ...
    // background images
    {
      ...
      setInterval(() => {
        ...
        if (this.counter % this.publication_interval == 0) {
          ...
          this.show_publication_idx =
            this.show_publication_idx % this.publications.length;
          this.publications;
        }
